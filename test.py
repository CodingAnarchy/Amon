...
contacts.add_contact('Chris Burg', '<redacted>', import_result.fingerprints[0])
contacts.add_contact('Chris Burg', '<also redacted>', None, primary=False)
print contacts.get_contact_key('Chris Burg')
print contacts.get_contact_email('Chris Burg')
print contacts.get_contact_email('Chris Burg', primary=False, alt_fp=None)
